...
void main(){			//main函数，必须的。
	...
	uart_set_io(1,UART1_PIN_P30_P31);//将串口1切换到P30和P31口
//	uart_set_io(1,UART1_PIN_P36_P37);//将串口1切换到P36和P37口
//	uart_set_io(1,UART1_PIN_P16_P17);//将串口1切换到P16和P17口
//	uart_set_io(1,UART1_PIN_P43_P44);//将串口1切换到P43和P44口	
	while(1){
